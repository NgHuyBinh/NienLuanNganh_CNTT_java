...
<div class="spacer services wowload fadeInUp" style="height:800px">
		...
		<div class="container text-center">
		    <form role="form" class="wowload fadeInRight" id="formresetpass">  
					<h3><label style="width:200px;text-align:left"  for="passcu">Mật khẩu cũ:</label>
					...
					<input style="color: black" type="password" id="passmoi2" name="passmoi2"><br><br></h3>
				    
				</form>   
				<h3><input style="color: black text-align:center" type="submit" id="updatepassword" value="Đổi mật khẩu"></h3>
            </div>
        </div>
    </div>
</div>
