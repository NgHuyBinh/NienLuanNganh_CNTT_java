...
<link rel="stylesheet" href="/luanvan/css/font-awesome.css" /> <!-- Font-Awesome-Icons-CSS -->
<link rel="stylesheet" href="/luanvan/css/style.css" type="text/css" media="all" /> <!-- Style-CSS --> 
<!-- //css files -->
<!-- web-fonts -->
